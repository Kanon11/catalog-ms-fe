...
export function ProductsPage() {
  ...
  // Writes are ADMIN/MANAGER only; SUPERVISOR is read-only (backend enforces too).
  ...
  // editing: null = closed; {} = create; { ...product } = edit.
  ...
  async function handleSubmit() {
    ...
    try {
      if (editing.id != null) {
        ...
        setEditing(null)
        // New product sorts last (by id) — jump to the page it lands on.
  ...
  return (
    <>
      ...
      <Modal
        title={editing?.id != null ? 'Edit product' : 'Add product'}
        open={editing != null}
        onOk={handleSubmit}
